                    ...
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-50', color: '#F5F5F5' }}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-200', color: '#efa198' }}
                                title="secondary[200]"
                                dark
                            />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-500', color: '#d93320' }}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-600', color: '#ba2c1b' }}
